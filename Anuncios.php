<?php 
	...
	*/
	...
	function f_an_slider() {
		...
		if($img1['src'] == ''){ $img1['src'] = WP_PLUGIN_URL.'/images/bannerdemo1.png'; }
		if($img2['src'] == ''){ $img2['src'] = WP_PLUGIN_URL.'/images/bannerdemo2.png'; }
		if($img3['src'] == ''){ $img3['src'] = WP_PLUGIN_URL.'/images/bannerdemo3.png'; }
		if($img4['src'] == ''){ $img4['src'] = WP_PLUGIN_URL.'/images/bannerdemo2.png'; }
		if($img5['src'] == ''){ $img5['src'] = WP_PLUGIN_URL.'/images/bannerdemo3.png'; }
		
	    // INICIA EL JS ********************************************************************************
	    $slidr_js = '';
		$slidr_js .= '<script type="text/javascript" src="'.WP_PLUGIN_URL.'/js/easySlider1.7.js"></script>';
